...
describe Dome do
  ...
  it 'outputs the correct message for a hiera lookup' do
    ...
    error_message = "Setting \e[0;32;49mTF_VAR_foo\e[0m to \e[0;32;49mbar\e[0m.\n"
  ...
  it 'outputs the correct error message for a failed hiera lookup' do
    ...
    error_message = "\e[0;31;49mHiera lookup failed for 'bar', so \e[0m\e[0;31;"\
      "49mTF_VAR_foo\e[0m\e[0;31;49m was not set.\e[0m\n"
    expect { hiera.secret_env_vars(vars) }.to output(error_message).to_stdout
  end
end
